...
typedef enum _STATE
{
    ...
    STATE_AC_OK,
    STATE_SCI,
    //STATE_AC_OFF, //[davidchchen]20161201 removed,not used 
};
/*************************************
    Type Define
*************************************/
...
typedef enum _CONTER_TYPE
{
	...
	COUNTER_BROWN_OUT,
	//COUNTER_AC_OFF,
	//COUNTER_SCI,        //[davidchchen]20161201 removed,not used
	//COUNTER_AC_WINDOW,
	//COUNTER_SD,
	COUNTER_SAG,
	//COUNTER_AC_NOTOK,   //[davidchchen]20161201 removed,not used
	COUNTER_AC_OK,
	COUNTER_RELAY_ON,
	//COUNTER_RELAY_OFF,  //[davidchchen]20161201 removed,not used
	COUNTER_PFC_ON,
