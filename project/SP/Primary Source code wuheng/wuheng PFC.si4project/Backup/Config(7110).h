...
/*====================================
    PIN definition
====================================*/
#define PFC_CTRL			PTBD_PTBD2
#define PFC_ON				1
#define PFC_OFF				0

#define AC_OK_CTRL			PTBD_PTBD4
#define AC_OK				0
#define AC_NOTOK			1

#define RELAY_CTRL			PTBD_PTBD7
#define RELAY_ON			1
#define RELAY_OFF			0

#define PFC_OK_CTRL			PTBD_PTBD3
#define PFC_OK				0
#define PFC_NOTOK			1

#define PFC_ADJUST_PIN		PTBD_PTBD6
#define PFC_ADJUST_ON		1
#define PFC_ADJUST_OFF		0

#define PFC_STB_CTRL		PTBD_PTBD5
#define PFC_STB_OK			1
#define PFC_STB_NOTOK		0

#define VRMS_DET			PTAD_PTAD3
...
====================================*/
//#define PFC_OK_REF              VDC_CONVERT(376)
#define PFC_OK_REF              VDC_CONVERT(390)
//#define PFC_NOTOK_REF_HL        VDC_CONVERT(350)
#define PFC_NOTOK_REF_HL        VDC_CONVERT(335)    //[davidchchen]20161201 modify 
//#define PFC_NOTOK_REF_HL        VDC_CONVERT(325)  //[davidchchen]20150210 modify
#define PFC_NOTOK_REF_LL        VDC_CONVERT(330)
#define PFC_STB_NOTOK_REF       VDC_CONVERT(250)
//#define PFC_OV_LATCHED_REF		VDC_CONVERT(450)//(435) //Chris, spec change
//#define PFC_OV_LATCHED_REF_H	VDC_CONVERT(460)
...
#define ACGD_REF                VAC_CONVERT(174) //(175)//For AC_OK_PIN, //davidchchen modify 20160425
#define ACNG_REF                VAC_CONVERT(167)
#define ACSAG_REF               VAC_CONVERT(157)
#define ACSD_REF				VAC_CONVERT(150)
#define AC_RECOVER_REF			VAC_CONVERT(264)
#define DCGD_REF                VDCIN_CONVERT(184) //(185) //For AC_OK_PIN, //davidchchen modify 20160425
#define DCNG_REF                VDCIN_CONVERT(177)
#define DCSAG_REF               VDCIN_CONVERT(167)
