...
Check if OVP
====================================*/
//[davidchchen]20161201 removed,not used
/*
byte IsOVP(void)
{
    return gSyncArray[COUNTER_PFC_OV_LATCHED][START_FLAG]; 
    //return 0;
}
*/
/*====================================
...
/*====================================
Set the Pin to high/low according to the type(delay)
====================================*/
//[davidchchen]20161201 removed,not used
/*
byte SetPin(byte CounterType, byte Pin, byte OnOff)
{
    StartDelay(CounterType);		
		
    if(IsDelay(CounterType))
	{
		Pin = OnOff;
		StopDelay(CounterType);
...
static unsigned int GetCounterRef(byte CounterType)
{
	...
	{                                                                                                             
		...
		//case COUNTER_SCI:             //[davidchchen]20161201 removed,not used
		//	return SCI_COUNTER_REF;     //[davidchchen]20161201 removed,not used
		...
		//case COUNTER_AC_NOTOK:          //[davidchchen]20161201 removed,not used
		//	return AC_NOTOK_COUNTER_REF;  //[davidchchen]20161201 removed,not used
		...
		//case COUNTER_RELAY_OFF:         //[davidchchen]20161201 removed,not used
		//	return RELAY_OFF_COUNTER_REF; //[davidchchen]20161201 removed,not used
